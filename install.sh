...
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/code-nautilus.py https://raw.githubusercontent.com/siddarta-weis/code-nautilus_pt-BR/master/code-nautilus.py
